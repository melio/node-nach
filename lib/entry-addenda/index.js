...
EntryAddenda.prototype.getReturnReason = function () {
  return achCodes.getReason(this.getReturnCode());
}
...
EntryAddenda.prototype.toJson = function () {
  ...
  if (achCodes.isAddendaReturn(addenda.addendaTypeCode)) {
    addenda.returnCode = this.getReturnCode();
    addenda.returnReason = this.getReturnReason();
  }
